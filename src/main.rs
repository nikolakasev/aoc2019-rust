...
fn five_computers_in_sequence(intcode: &str, phase_setting: Vec<i64>) -> i64 {
...
#[cfg(test)]
mod tests {
    use crate::{computer, five_computers_in_sequence, str_to_intcode};
